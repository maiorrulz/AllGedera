...
public class genericEventTest extends TestCase {
    ...
    public void testCheckSettersGetters(){
        ...
        assertNotNull(interiorDesign.getName());
        assertNotNull(interiorDesign.getAbout());
        assertNotNull(interiorDesign.getAddress());
        assertNotNull(interiorDesign.getPhone());
        assertEquals(31.812301, interiorDesign.getLocation().getLatitude());
